...
A aplicação foi desenvolvida como atividade acadêmica, com o objetivo de demonstrar domínio sobre:
...
JavaScript (ES6+) – Lógica da aplicação e consumo das APIs
